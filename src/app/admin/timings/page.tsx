...
export default function EditTimingsPage() {
  ...
  const { timings, updateTimings } = useContent();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!content.trim()) {
      alert('Please enter the temple timings');
      return;
    }

    updateTimings({ content });
    showSuccess('Temple timings updated successfully!');
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-50 pt-20 pb-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-amber-900 mb-2">⏰ Edit Temple Timings</h1>
          <p className="text-lg text-amber-700">Update the opening hours and timing information</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <textarea
                ...
                placeholder="Enter temple timings (e.g., Morning: 6:00 AM - 12:00 PM...)"
              ...
              <p className="mt-2 text-sm text-gray-600">
                Tip: Use line breaks to separate different timings. Example:
                <br />
