...
export default function EditHistoryPage() {
  ...
  const { templeHistory, updateTempleHistory } = useContent();
  ...
  useEffect(() => {
    setMounted(true);
    setHistory(templeHistory.history);
  }, [templeHistory]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!history.trim()) {
      alert('Please enter the temple history');
      return;
    }

    updateTempleHistory({ history });
    showSuccess('Temple history updated successfully!');
  };
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-50 pt-20 pb-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-amber-900 mb-2">📖 Edit Temple History</h1>
          <p className="text-lg text-amber-700">Update the history and background information about Shri Pundalingeshwar Temple</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <textarea
                ...
                placeholder="Enter the history and background of the temple..."
